...
| Refinamento de requisitos                          | Lista formal de requisitos funcionais e não funcionais; </br> Backlog do produto organizado em User Stories devidamente priorizadas; </br> Proposta de MVP1 e MVP2.                          | 08/10/23 | 24/10/23 |
| Início da implementação dos requisitos             | Primeiras versões do produto de software desenvolvido.                                                                                                                                       | 27/10/23 | 23/11/23 |
| Finalização do produto                             | Versão final do produto de software com todos os seus requisitos devidamente implementados e testados                                                                                        | 24/11/23 | 14/12/23 |
...
A metodologia de desenvolvimento de software escolhida pelo grupo foi: Uma abordagem Ágil, com ciclo de vida iterativo e incremental com atividades utilizadas pelo Scrum e XP. Aplicaremos: as daily scrum, desde o início do projeto, dando feedbacks acerca das atividades desenvolvidas pelo grupo; Sprint Planning, para definir o escopo da sprint; Sprints com prazo de duração de duas semanas no período de desenvolvimento; Sprint Review com o cliente para receber os feedbacks da entrega; e a Sprint Retrospective com o grupo, para discutir os pontos fortes e fracos da sprint e sugerir melhorias para o grupo como um todo.

| Nome da Atividade                                | Método                                                                                                                                                                                                                                                       | Ferramenta                                                                                                                                                         | Entrega                                                                                                                     |
| ------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------- |
| Análise do problema e levantamento de requisitos | Elicitação e descoberta, identificação do problema e definição básica do produto, levantamento de forma resumida dos requisitos funcionais e não funcionais; Representação informal ; Declaração e comunicação do que será passado para a próxima atividade. | Google meet, Google docs, Google Planilha.                                                                                                                         | Versão preliminar dos requisitos funcionais e não funcionais do produto                                                     |
...
| Sprint Planning                                       | Reunião com o cliente para definir o escopo da sprint | Google meet | Lista de histórias estáveis que irão entrar na sprint                                                                                   |
| Sprint                                      | Implementação dos requisitos priorizados e estabelecidos conforme os MVP1 e MVP2; Testes     | Google meet, Visual Studio Code, React com Nextjs, Typescript, Axios, Styled-Components, Vercel, Google Maps API, Java, Spring-Boot, Docker, PostgreSQL, SupaBase. | Produto de software referente ao escopo da sprint. |
...
| Sprint Review|Reunião com o cliente para apresentar a representação formal do que foi implementado e validar a entrega| Google Meet, Google Planilha, Google docs. | Feedback do cliente acerca da entrega da sprint. |
